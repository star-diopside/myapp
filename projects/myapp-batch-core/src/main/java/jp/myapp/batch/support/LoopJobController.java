 ...
 * 繰り返しジョブ実行コントローラークラス
 */
public class LoopJobController implements JobExecutionListener, JobExecutionDecider, JobParametersExtractor,
        LoopJobParametersListAccessor, InitializingBean {
