...
@Service
public class XlsDataSetExport implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        try (ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("applicationContext.xml")) {
            Runnable obj = context.getBean("xlsDataSetExport", Runnable.class);
            obj.run();
        }
    }
    ...
    public void run() {
        ...
        try {
            ...
            try (FileOutputStream out = new FileOutputStream("export.xls")) {
